...
const ca = tslib_1.__importStar(require("./https/ca"));
...
const IP_CACHE = new import_pkg_1.LRU({ max: 600 });
...
function tunnelProxy(server, proxy, type) {
    ...
    server.on('connect', function (req, reqSocket) {
        ...
        if (headers[config_1.default.WEBUI_HEAD]) {
        ...
        const parseUrl = function (_url, port) {
            _url = _url || tunnelUrl;
            options = req.options = import_pkg_1.url.parse(_url);
        ...
        const isIPHost = !isICloundCKDB && import_pkg_1.net.isIP(hostname);
        let policy = headers[config_1.default.WHISTLE_POLICY_HEADER];
        ...
        let isLocalUIUrl = !useTunnelPolicy && config_1.default.isLocalUIUrl(hostname);
        if (isLocalUIUrl ? isIPHost : util.isLocalHost(hostname)) {
            isLocalUIUrl = options.port == config_1.default.port || options.port == config_1.default.uiport;
        }
        let _rules = {};
        ...
        rules.resolveRulesFile(req, function () {
            ...
            const isIntercept = function () {
                ...
                reqSocket.useProxifier = (config_1.default.proxifier2 || (config_1.default.proxifier && isWebPort)) && !disable.proxifier;
            ...
            let plugin = resolvedPlugin ? plugins_1.pluginMgr.resolveWhistlePlugins(req) : null;
            ...
            plugins_1.pluginMgr.getTunnelRules(req, function (_rulesMgr) {
                handlePluginRules(_rulesMgr);
                policy = headers[config_1.default.WHISTLE_POLICY_HEADER];
                if (!reqSocket._hasError && !req._authForbidden && !req.fromComposer && (req._forceCapture || isIntercept())) {
                    ...
                    (0, https_1.default)(reqSocket, function (chunk) {
                        if (isLocalUIUrl || (isIPHost && util.isLocalAddress(hostname) && options.port == config_1.default.port)) {
                ...
                function ensureLoadRules() {
                    ...
                    if (!resolvedPlugin) {
                        plugin = plugins_1.pluginMgr.resolveWhistlePlugins(req);
                    }
                    plugins_1.pluginMgr.getTunnelRules(req, function (_rulesMgr2) {
                ...
                function handleTunnel() {
                    ...
                    resData = { headers: {} };
                    reqEmitter = new import_pkg_1.EventEmitter();
                    data = {
                        id: req.reqId,
                        url: options.host,
                        startTime: Date.now(),
                    ...
                    if (util.showPluginReq(req) && config_1.default.captureData && (!filter.hide || disable.hide)) {
                    ...
                    util.parseRuleJson(_rules.reqHeaders, function (reqHeaders) {
                        ...
                        if (reqHeaders) {
                            ...
                            customXFF = reqHeaders[config_1.default.CLIENT_IP_HEAD];
                        ...
                        if (disable.clientIp || disable.clientIP) {
                            ...
                            else if (import_pkg_1.net.isIP(customXFF)) {
                                headers[config_1.default.CLIENT_IP_HEAD] = customXFF;
                            }
                        ...
                        plugins_1.pluginMgr.loadPlugin(req.isPluginReq ? null : plugin, function (err, ports) {
                            ...
                            if (tunnelPort) {
                                ...
                                plugins_1.pluginMgr.addRuleHeaders(req, _rules);
                                headers[config_1.default.PLUGIN_HOOK_NAME_HEADER] = config_1.default.PLUGIN_HOOKS.TUNNEL;
                                ...
                                if (proxyUrl) {
                                    ...
                                    getServerIp(_url, function (ip) {
                                        ...
                                        if (isProxyPort && util.isLocalAddress(ip)) {
                                            return emitError(new Error('Self loop (' + ip + ':' + config_1.default.port + ')'));
                                        }
                                        ...
                                        const dstOptions = import_pkg_1.url.parse(tunnelUrl);
                                        ...
                                        util.deleteReqHeaders(req);
                                        const _headers = (0, import_pkg_1.extend)({}, headers);
                ...
                function tunnel(hostIp, hostPort) {
                    getServerIp(tunnelUrl, function (ip, port) {
                        ...
                        req.serverPort = reqSocket.serverPort = resData.port;
                        resSocket = import_pkg_1.net.connect(resData.port, ip, handleConnect);
                        if (retryConnect) {
                            handleError(resSocket);
                        }
                        else {
                ...
                function handleConnect() {
                    ...
                    plugins_1.pluginMgr.resolvePipePlugin(reqSocket, function () {
                        if (reqSocket._hasError) {
                            return emitError(socketErr);
                        }
                ...
                function sendEstablished(code, cb) {
                    if (res) {
                        ...
                        if (!res.headers['proxy-agent']) {
                            res.headers['proxy-agent'] = config_1.default.name;
                    ...
                    plugins_1.pluginMgr.getResRules(req, res, function () {
                        ...
                        util.parseRuleJson(rollBackTunnel ? null : reqRules.resHeaders, function (newResHeaders) {
                            if (rollBackTunnel) {
                                ...
                                if (newResHeaders) {
                                    ...
                                    (0, import_pkg_1.extend)(resHeaders, newResHeaders);
                                }
                                ...
                                const message = code == 200 ? 'Connection Established' : import_pkg_1.http.STATUS_CODES[code] || 'unknown';
                ...
                function emitError(err) {
                    ...
                    plugins_1.pluginMgr.postStats(req, resData);
                }
            });
        });
    });

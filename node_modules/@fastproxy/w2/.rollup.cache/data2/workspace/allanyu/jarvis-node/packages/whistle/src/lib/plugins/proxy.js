import { create as createAgent } from 'hagent';
import { formatHeaders } from 'hparser';
import { LRU, extend, http, net, parseUrl } from '../import-pkg';
import * as common from '../util/common';
const getServer = createAgent(function () {
...
export default function (options, cb) {
    ...
    getServer(function (server, port) {
        ...
        const connect = function (opts, cb) {
            const socket = net.connect(tempServerOpts, cb);

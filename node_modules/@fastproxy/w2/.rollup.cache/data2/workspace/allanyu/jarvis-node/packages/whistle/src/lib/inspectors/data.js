...
import * as zlib from '../util/zlib';
import * as util from '../util';
import * as socketMgr from '../socket-mgr';
import config from '../config';
const MAX_BODY_SIZE = 360 * 1024;
const MAX_SIZE = (config.strict ? 256 : 768) * 1024;
const MAX_REQ_BODY_SIZE = (config.strict ? 256 : 1536) * 1024;
const MAX_RES_BODY_SIZE = (config.strict ? 256 : 1536) * 1024;
...
export function inspectData(req, res, next) {

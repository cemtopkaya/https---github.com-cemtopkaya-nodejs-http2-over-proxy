...
export const inflate = createConvenienceMethod(zlib.Inflate);
export const gunzip = createConvenienceMethod(zlib.Gunzip);
export const inflateRaw = createConvenienceMethod(zlib.InflateRaw);
export function unzip(encoding, body, callback) {
